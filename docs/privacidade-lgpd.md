...
Procuradoria Geral do Estado SP: Emissão de GARE de Liquidação segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pge_sp_emissao_gare@mcp.ai](mailto:pge_sp_emissao_gare@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
